...
<Step number={1} title='About CSIR JRF-NET' />
...
<Step number={2} title='About NewFms Portal' />
...
<Step number={3} title='Registration of New JRFs' />
...
<Step number={5} title='Welcome to NewFms Portal' />
...
<Step number={6} title='Monthly Fellowship Claim' />
